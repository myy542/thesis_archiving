...
$department_projects = [
    ...
    ['id' => 10, 'title' => 'Mobile Learning App', 'student' => 'Gabriela Silang', 'adviser' => 'Dr. Lisa Garcia', 'submitted' => '2024-03-06', 'status' => 'pending', 'defense_date' => null],
];

// Upcoming defenses (schedule)
$upcoming_defenses = [
...
<head>
    ...
    <style>
        * {
        ...
        /* UPDATED: Logo container with CENTERED text */
        .logo-container {
            padding: 0 25px;
            margin-bottom: 40px;
            text-align: center;
...
<body>
    <!-- SIDEBAR - UPDATED: ThesisManager ug ADMIN (stacked and centered) -->
    <div class="sidebar">
        ...
        <div class="defenses-section">
            ...
            <div class="defense-item">
                <div class="defense-date-box">
                    ...
                    <div class="defense-month"><?php echo date('M', strtotime($defense['date'])); ?></div>
                </div>
